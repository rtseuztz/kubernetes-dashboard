...
import { namespace_events } from "./routes/data"
...
export function initializeResource(resource: string): any[] {
    const res = execSync(`kubectl get ${resource}`, { 'shell': 'powershell.exe' })
